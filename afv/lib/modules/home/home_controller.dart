...
class HomeController extends GetxController with MessagesMixin, LoaderMixin {
  ...
  doLogout() async {
    try {
      loading(true);
      bool logout = await _loginViewModel.doLogout();
      if (logout) {
  ...
  getData() async {
    try {
      loading(true);
      Future.wait([
        _customersViewModel.getCustomers(),
        _customersViewModel.getFinancialPositionData(),
        //_customersViewModel.getCustomersSales(),
        _productsViewModel.getProdutos(),
        _productsViewModel.getPricesList(),
        _notSaleViewModel.getNotSale(),
      ]);
      loading(false);
