...
class _PinPaint extends CustomPainter {
  ...
  _drawBoxTight(Canvas canvas, Size size) {
    ...
    for (var rune in text.runes) {
      ...
      startX = dr.strokeWidth * (index + 1) +
          ...
          singleWidth / 2 -
          textPainter.width / 2;
      textPainter.paint(canvas, Offset(startX as double, startY as double));
      index++;
    }
  ...
  _drawBoxLoose(Canvas canvas, Size size) {
    ...
    num startX = dr.strokeWidth / 2;
    num startY = mainHeight - dr.strokeWidth / 2;
    ...
    for (var rune in text.runes) {
      ...
      startX = singleWidth * index +
          ...
          dr.strokeWidth;
      textPainter.paint(canvas, Offset(startX, startY as double));
      index++;
    }
  ...
  _drawUnderLine(Canvas canvas, Size size) {
    ...
    num startX = 0.0;
    num startY = mainHeight - dr.lineHeight;
    ...
    for (int i = 0; i < pinLength; i++) {
      ...
      canvas.drawLine(Offset(startX as double, startY as double),
  ...
  _sumList<T extends num>(Iterable<T> list) {
    num sum = 0;
    for (var n in list) {
      sum += n;
    }
